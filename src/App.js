import React, {Component, useRef, useState, useEffect, memo, createContext, useContext} from 'react'
import './App.css';
...
function App() {
  ...
  return ( 
    <Provider value={data}>
      <Form text={data.text}/>
      <button onClick={() => setData({ mail: 'second@example.com', text: 'another text', forceChangeMail})}>Click me</button>
    </Provider>
  )
}
